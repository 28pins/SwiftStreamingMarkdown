...
public struct TextFonts: Hashable, Sendable {
  ...
  public let normal: PlatformFont
  ...
  public init(normal: PlatformFont, italic: PlatformFont?, bold: PlatformFont?, boldItalic: PlatformFont?, preferredLetterSpacing: CGFloat?, preferredLineHeight: CGFloat?) {
    self.normal = normal
    self.italic = italic
    self.bold = bold
...
extension TextFonts {
  ...
  func italicize(font: PlatformFont) -> PlatformFont? {
  ...
  func bold(font: PlatformFont) -> PlatformFont? {
